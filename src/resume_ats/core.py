...
from .exceptions import BuildError, CompilationError, TemplateError
...
class ResumeBuilder:
    ...
    @classmethod
    def from_yaml(
        cls, yaml_path: Path, config: Optional[BuildConfig] = None
    ) -> "ResumeBuilder":
        ...
        with Progress(
            ...
            try:
                ...
                if result.returncode != 0:
                    error_msg = (
                        f"XeLaTeX compilation failed (exit code {result.returncode})"
                    )
